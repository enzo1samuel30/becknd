print("="*11 + "LOJAS SANTOS"+"="*11) preco float(input("Preço das compras"))
...
total juros/parcela
0 print("A sua compra no cartão vai ser feita em {} parcelas e o valor com juros de cada parcela fica {}".format
(parcela, total))
